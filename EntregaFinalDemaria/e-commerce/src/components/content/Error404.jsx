...
const Error404 = () => {
    return (
        <>
        <div className='bodyError404'>
            <div className="notFound-copy">
                
                <svg alt="404 Page not found" className="not-found">
                ...
                <h1>Lo lamentamos. No pudimos encontrar lo que solicitó.</h1>
            ...
            <svg aria-labelledby="Starry sky" alt="Starry sky" className="starry-sky">
                ...
                <g className="moon">
                    ...
                    <path opacity=".1" fillRule="evenodd" clipRule="evenodd" fill="#3B3D3D" d="M201.2 368.2l-.4-.8c-.4-.7-1.4-1-2.1-.6l-80.5 46.8c-.7.4-1 1.4-.6 2.1l.4.8c.3.5.8.8 1.4.8.3 0 .5-.1.8-.2l1-.6c0 .1.1.3.2.4l24.2 41.7c.2.4.7.7 1.2.7.2 0 .5-.1.7-.2l34.1-19.8c.3-.2.5-.5.6-.8.1-.4 0-.7-.1-1l-24.2-41.7-.3-.3 43.2-25.1c.4-.2.6-.5.7-1-.1-.4-.1-.8-.3-1.2z" />
